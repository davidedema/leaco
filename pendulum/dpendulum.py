...
class DPendulum:
    ...
    def __init__(self, nq=51, nv=21, nu=11, vMax=5, uMax=5, dt=0.2, ndt=1, noise_stddev=0, which_viewer='meshcat'):
        ...
        self.pendulum.DT  = dt
        self.pendulum.NDT = ndt # number of integration steps for each dt
    ...
    @property
    def nx(self): return self.nq*self.nv    # size of the state space
    @property
    ...
    def x2i(self, x): return x[0]+x[1]*self.nq   # nq-1 + (nv-1)*nq = nv*nq-1
